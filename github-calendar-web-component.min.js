(function (GitHubCalendar) {
    ...
    var GitHubCalendar__default = /*#__PURE__*/_interopDefaultLegacy(GitHubCalendar);
    ...
    class GitHubCalendarElement extends HTMLElement {
        ...
        connectedCallback() {
            this.render();
            this.ghc = new GitHubCalendar__default['default'](
        ...
        get username() {
            return this.hasAttribute('username') ? this.getAttribute('username') : '';
        }
